...
void SelfPlayPrisonersDilemma(
    int seed, int total_episodes, int report_every, int num_eval_episodes) {
  ...
  for (int num_episodes = 0;
    ...
    std::cout << num_episodes + report_every << " "
              ...
              << avg_self_play_returns[0] << " "
              << avg_self_play_returns[1] << std::endl;
  }
}
