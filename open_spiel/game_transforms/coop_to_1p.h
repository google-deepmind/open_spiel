...
#ifndef THIRD_PARTY_OPEN_SPIEL_GAME_TRANSFORMS_COOP_TO_1P_H_
#define THIRD_PARTY_OPEN_SPIEL_GAME_TRANSFORMS_COOP_TO_1P_H_
...
#endif  // THIRD_PARTY_OPEN_SPIEL_GAME_TRANSFORMS_COOP_TO_1P_H_
