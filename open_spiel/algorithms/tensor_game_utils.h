...
#ifndef THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_TENSOR_GAMES_UTILS_H_
#define THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_TENSOR_GAMES_UTILS_H_
...
#endif  // THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_TENSOR_GAME_UTILS_H_
