...
#include "open_spiel/algorithms/alpha_zero/vpnet_v2.h"
...
bool CreateGraphDefV2(const Game& game, double learning_rate,
  ...
  return RunPython("open_spiel.python.algorithms.alpha_zero.export_model_v2",
                   {
...
VPNetModelV2::VPNetModelV2(const Game& game, const std::string& path,
...
std::string VPNetModelV2::SaveCheckpoint(int step) {
...
void VPNetModelV2::LoadCheckpoint(const std::string& path) {
...
std::vector<VPNetModelV2::InferenceOutputs> VPNetModelV2::Inference(
...
VPNetModelV2::LossInfo VPNetModelV2::Learn(const std::vector<TrainInputs>& inputs) {
