...
#ifndef THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_CC_VPNET_H_
#define THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_CC_VPNET_H_
...
class VPNetModel {
 ...
 public:
  ...
  struct TrainInputs {
    std::vector<int> legal_action_masks;
    std::vector<double> observations;
    std::vector<double> policy_targets;
...
#endif  // THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_CC_VPNET_H_
