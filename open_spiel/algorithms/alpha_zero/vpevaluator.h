...
#ifndef THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_VPEVALUATOR_H_
#define THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_VPEVALUATOR_H_
...
#endif  // THIRD_PARTY_OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_VPEVALUATOR_H_
