...
std::unique_ptr<std::string> CFRSolverBase::Serialize(
    std::string delimiter) const {
  auto str = std::make_unique<std::string>();

  // Meta section
  absl::StrAppend(
      str.get(), "# Automatically generated by OpenSpiel "
      "CFRSolverBase::Serialize\n");
  absl::StrAppend(str.get(), kSerializeMetaSectionHeader, "\n");
  absl::StrAppend(str.get(), "Version: ", kSerializationVersion, "\n");
  absl::StrAppend(str.get(), "\n");
  ...
  absl::StrAppend(str.get(), SerializeThisType(), "\n", iteration_, "\n");
  SerializeCFRInfoStateValuesTable(info_states_, str.get(), delimiter);
