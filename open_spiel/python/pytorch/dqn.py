...
class DQN(rl_agent.AbstractAgent):
  ...
  def save(self, data_path, optimizer_data_path=None):
    ...
    Args:
      data_path: Path for saving model. It can be relative or absolute but
        the filename should be included. For example: q_network.pt or
  ...
  def load(self, data_path, optimizer_data_path=None):
    ...
    Args:
      data_path: Path for loading model. It can be relative or absolute but
        the filename should be included. For example: q_network.pt or
        /path/to/q_network.pt
