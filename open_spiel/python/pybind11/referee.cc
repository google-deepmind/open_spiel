...
void init_pyspiel_referee(py::module& m) {
  ...
  settings.def(py::init<int, int, int, int, int, int, int, double>(),
               py::arg("timeout_ready") = 200,
               py::arg("timeout_start") = 100,
               py::arg("timeout_act") = 100,
               py::arg("timeout_ponder") = 50,
               py::arg("timeout_match_over") = 100,
               py::arg("time_tournament_over") = 100,
               py::arg("max_invalid_behaviors") = 1,
               py::arg("disqualification_rate") = .1);
  settings.def_readonly("timeout_ready",
                        &higc::TournamentSettings::timeout_ready)
      .def_readonly("timeout_start",
                    &higc::TournamentSettings::timeout_start)
      .def_readonly("timeout_act",
                    &higc::TournamentSettings::timeout_act)
      .def_readonly("timeout_ponder",
                    &higc::TournamentSettings::timeout_ponder)
  ...
  results.def_readonly("num_bots", &higc::TournamentResults::num_bots)
      ...
      .def_readonly("disqualified",
                    &higc::TournamentResults::disqualified)
  ...
  // TODO(sustr): expose ostream in Python for logging.
  ...
  referee.def(py::init<const std::string&,
