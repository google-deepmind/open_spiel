...
void open_spiel::init_pyspiel_games_dots_and_boxes(py::module& m) {
  py::classh<DotsAndBoxesState, State>(m, "DotsAndBoxesState")
      ...
      // .def("debug_string", &DotsAndBoxesState::DebugString)
      //.def("parse_move_to_action", &DotsAndBoxesState::ParseMoveToAction)
      // Pickle support
      .def(py::pickle(
          ...
          [](const std::string& data) {  // __setstate__
            ...
            return dynamic_cast<DotsAndBoxesState*>(game_and_state.second.release());
          }));
}
