...
from open_spiel.python.games import dummy_dynamic_routing_game  # pylint: disable=unused-import
import pyspiel
...
class DynamicRoutingGameTest(absltest.TestCase):
    ...
    def test_random_game(self):
        ...
        game = pyspiel.load_game("python_dummy_dynamic_routing_game")
    ...
    def test_game_as_turn_based_via_string(self):
        ...
        game = pyspiel.load_game(
            "turn_based_simultaneous_game(game=python_dummy_dynamic_routing_game())"
        )
        pyspiel.random_sim_test(
            game, num_sims=10, serialize=False, verbose=True)
    ...
    def test_generate_playthrough(self):
        ...
        generate_playthrough.playthrough("python_dummy_dynamic_routing_game", None)
