...
class AntForagingTest(absltest.TestCase):
    ...
    def test_custom_parameters(self):
        """Test game with custom parameters."""
        game = pyspiel.load_game("python_ant_foraging", {
            "grid_size": 10,
            "num_ants": 3,
            "num_food": 5,
        ...
        self.assertEqual(game.num_food, 5)
    ...
    def test_turn_progression(self):
        ...
        game = pyspiel.load_game("python_ant_foraging", {"num_ants": 2})
        state = game.new_initial_state()
    ...
    def test_game_terminates(self):
        ...
        # Play until terminal
        step_count = 0
        while not state.is_terminal() and step_count < 100:
            legal = state.legal_actions()
            state.apply_action(legal[0])
            step_count += 1
    ...
    def test_random_simulation(self):
        ...
        for _ in range(5):
            ...
            self.assertEqual(len(returns), game.num_players())
