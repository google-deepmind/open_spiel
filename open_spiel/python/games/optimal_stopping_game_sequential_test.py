"""
Tests for optimal_stopping_game_sequential.py.
"""
...
class OptimalStoppingGameSequentialTest(absltest.TestCase):
    ...
    def test_default_param(self) -> None:
        ...
        :return: None
        """
        game = pyspiel.load_game("python_optimal_stopping_game_sequential")
    ...
    def test_non_default_param_from_string(self) -> None:
        ...
        game = pyspiel.load_game(
            "python_optimal_stopping_game_sequential(p=0.5)")
    ...
    def test_game_as_turn_based_via_string(self) -> None:
        ...
        """
        game = pyspiel.load_game(
            "turn_based_simultaneous_game(game=python_optimal_stopping_game_sequential())"
        )
