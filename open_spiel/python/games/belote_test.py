...
class BeloteTest(absltest.TestCase):
    ...
    def test_can_create_game_and_state(self):
        ...
        game = belote.BeloteGame({"hand_length": 3, "num_digits": 3})
    ...
    def test_basic_bid(self):
        ...
        bid_offset = belote.BID_ACTION_OFFSET
        ...
        for next_action in state.legal_actions():
            if next_action == belote.CHALLENGE_ACTION:
                continue
    ...
    def test_single_random_round(self):
        ...
        challenge = belote.CHALLENGE_ACTION
    ...
    def test_single_deterministic_round(self):
        ...
        state.apply_action(state.encode_bid(4, 1) + belote.BID_ACTION_OFFSET)
        # Player 1 challenges.
        state.apply_action(belote.CHALLENGE_ACTION)
    ...
    def test_game_from_cc(self):
        ...
        game = pyspiel.load_game("python_belote", {"players": 2})
