...
class TicTacToeTest(absltest.TestCase):
  ...
  def test_game_from_cc(self):
    ...
    game = pyspiel.load_game("python_gt3")
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "gt3.txt")
    py_playthrough = os.path.join(path, "python_gt3.txt")
    ...
    self.assertEqual(
        diffs, {
            "- game: gt3\n",
            "+ game: python_gt3\n",
            '- GameType.long_name = "GT3"\n',
            '+ GameType.long_name = "Python Tic-Tac-Toe"\n',
            '- GameType.short_name = "gt3"\n',
            '+ GameType.short_name = "python_gt3"\n',
            '- ToString() = "gt3()"\n',
            '+ ToString() = "python_gt3()"\n',
            "- CurrentPlayer() = -4\n",
  ...
  def test_consistent(self):
    ...
    py_game = pyspiel.load_game("python_gt3")
    cc_game = pyspiel.load_game("gt3")
