...
from open_spiel.python.mfg.algorithms import policy_value_distribution
from open_spiel.python.mfg.games import crowd_modelling
import pyspiel


class PolicyValueDistributionTest(absltest.TestCase):
  """Test class of the PolicyValueDistribution."""
  ...
  def test_python_game(self):
    ...
    py_value = policy_value_distribution.PolicyValueDistribution(
      game, dist, uniform_policy)
