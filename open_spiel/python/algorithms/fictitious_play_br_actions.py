...
class XFPSolver(object):
  ...
  """
    ...
    def __init__(self, game, br_list, save_oracles=False):
    ...
    def compute_best_responses(self):
        ...
        for i in range(self._num_players):
            ...
            br_info = exploitability_br_actions.best_response(self._game, self._br_list, joint_policy.to_tabular(), i)
    ...
    def _recursively_update_average_policies(self, state, avg_reach_probs,
        ...
        if state.is_terminal():
            ...
            for br in self._br_list:
                try:
                    br_policy = _policy_dict_at_state(br[player], state)
