...
flags.DEFINE_enum("nn_api", "linen", ["linen", "nnx"],
...
flags.DEFINE_integer("temperature_drop", 4,  # Less than AZ due to short games.
...
flags.DEFINE_integer("evaluators", 4, "How many evaluators to run.")
