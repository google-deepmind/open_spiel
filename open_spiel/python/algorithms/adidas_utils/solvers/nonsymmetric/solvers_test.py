...
from open_spiel.python.algorithms.adidas_utils.solvers.nonsymmetric import sgd
...
class ExploitabilityDescentTest(parameterized.TestCase):
  ...
  def test_exploitability_gradient_on_nonsymmetric_three_player_matrix_games(
    ...
    for _ in range(trials):
      ...
      params = prep_params(dist, payoff_tensor, num_params)
      ...
      if num_estimates > 1:
        payoff_matrices = [payoff_matrices] * num_estimates
      ...
      num_grad = np.concatenate(numerical_gradient(exp, dist))
