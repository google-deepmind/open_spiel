...
def make_observation(
  ...
  """Returns an _Observation instance if the imperfect_information_observation_type is supported, otherwise None.""" # Summary line too long, so pylint: disable=line-too-long
  params = params or {}
