...
"""This compares the speed and results of the original implementeation of CFR with the Jax implementation

The results slightly differ due to different rounding of regrets between original implmentation and CFR. When setting clamping of regrets to 1e-8 the results are exactly the same.
"""
