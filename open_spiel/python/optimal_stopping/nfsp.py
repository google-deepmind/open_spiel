...
def main(unused_argv):
    ...
    print(f"info state size:{info_state_size}, num actions:{num_actions}")
    ...
    with tf.Session() as sess:
        ...
        for ep in range(FLAGS.num_train_episodes):
            ...
            while not time_step.last():
                ...
                agent_outputs = []
                for agent in agents:
                    agent_outputs.append(agent.step(time_step))
                # print(f"agent outputs:{agent_outputs}")
                action_list = list(map(lambda x: x.action, agent_outputs))
