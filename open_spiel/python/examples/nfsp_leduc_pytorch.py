...
flags.DEFINE_integer(
    "num_train_episodes", int(20e6), "Number of training episodes."
)
...
flags.DEFINE_float(
    "rl_learning_rate", 0.01, "Learning rate for inner rl agent."
)
flags.DEFINE_float(
    "sl_learning_rate", 0.01, "Learning rate for avg-policy sl network."
)
flags.DEFINE_string(
    "optimizer_str", "sgd", "Optimizer, choose from 'adam', 'sgd'."
)
flags.DEFINE_string(
    "loss_str", "mse", "Loss function, choose from 'mse', 'huber'."
)
flags.DEFINE_integer(
...
flags.DEFINE_string(
    "checkpoint_dir",
    os.path.join(tempfile.gettempdir(), "nfsp_test"),
