...
flags.DEFINE_integer(
    "eps_decay_steps", 49000, "Number of episodes to decay epsilon"
)
flags.DEFINE_integer(
    "replay_buffer_capacity", int(1e4), "Size of replay buffer"
)

# Misc parameters
flags.DEFINE_integer("num_runs", 10, "Number of repetitions")
flags.DEFINE_integer(
    "log_interval", 100, "Number of episodes between each logging"
)
