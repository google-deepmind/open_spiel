...
from open_spiel.python.algorithms.alpha_zero.utils import AVIALABLE_APIS, api_selector
...
flags.DEFINE_integer(
  "replay_buffer_size", 2**13, "How many states to store in the replay buffer."
)
flags.DEFINE_integer(
...
flags.DEFINE_integer("evaluation_window", 50, "How many games to average results over.")
