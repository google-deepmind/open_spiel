...
flags.DEFINE_string("game", "python_dominoes", "Name of the game.")
...
flags.DEFINE_enum("player3", "mcts", _KNOWN_PLAYERS, "Who controls player 2.") 
flags.DEFINE_enum("player4", "az", _KNOWN_PLAYERS, "Who controls player 2.") 
...
def main(argv):
  ...
  if game.num_players() != 4:
    sys.exit("This game requires does not require 4 players. The example can only handle 4-player games.")
  bots = [
      _init_bot(FLAGS.player1, game, 0),
      _init_bot(FLAGS.player2, game, 1),
      _init_bot(FLAGS.player3, game, 0),
      _init_bot(FLAGS.player4, game, 1),
