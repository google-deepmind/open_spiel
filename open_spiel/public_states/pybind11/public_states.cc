...
void init_pyspiel_public_states(::pybind11::module& m) {
  ...
  game_with_public_states_type
      ...
      .def_readonly("provides_state_compatibility_check",
                    &ps::GameWithPublicStatesType::provides_state_compatibility_check)
      .def("__repr__",
           [](const ps::GameWithPublicStatesType& gt) {
               return "<GameWithPublicStatesType '" + gt.short_name + "'>";
           });

  py::class_<ps::PrivateInformation>
      private_information(m, "PrivateInformation");
  private_information
      .def("get_player", &ps::PrivateInformation::GetPlayer)
  ...
  game.def("new_initial_public_state",
      ...
      .def("num_public_features",
           &ps::GameWithPublicStates::NumPublicFeatures)
      .def("network_input_size",
           &ps::GameWithPublicStates::NetworkInputSize)
      ...
      .def("get_base_game",
           &ps::GameWithPublicStates::GetBaseGame);
  ...
  public_state
      ...
      .def("get_private_informations",
           &ps::PublicState::GetPrivateInformations)
      .def("get_public_set",
           &ps::PublicState::GetPublicSet)
      .def("get_information_state",
           &ps::PublicState::GetInformationState)
      .def("get_information_set",
           &ps::PublicState::GetInformationSet)
      .def("get_world_state",
           &ps::PublicState::GetWorldState)
      .def("resample_from_public_set",
           &ps::PublicState::ResampleFromPublicSet)
      .def("resample_from_information_set",
           &ps::PublicState::ResampleFromInformationSet)
      .def("apply_public_transition",
           &ps::PublicState::ApplyPublicTransition)
      .def("apply_state_action",
           &ps::PublicState::ApplyStateAction)
      .def("child",
           &ps::PublicState::Child)
      .def("legal_transitions",
           &ps::PublicState::LegalTransitions)
      .def("get_private_actions",
           &ps::PublicState::GetPrivateActions)
      .def("undo_transition",
           &ps::PublicState::UndoTransition)
      .def("is_public_transition_legal",
           &ps::PublicState::IsTransitionLegal)
      .def("is_chance",
           &ps::PublicState::IsChance)
      .def("is_terminal",
           &ps::PublicState::IsTerminal)
      .def("is_player",
           &ps::PublicState::IsPlayer)
      .def("acting_players",
           &ps::PublicState::ActingPlayers)
      .def("terminal_returns",
           &ps::PublicState::TerminalReturns)
      .def("compute_reach_probs",
           &ps::PublicState::ComputeReachProbs)
      .def("terminal_cf_values",
           &ps::PublicState::TerminalCfValues)
      .def("compute_cf_priv_values",
           &ps::PublicState::ComputeCfPrivValues)
      .def("compute_cf_action_values",
           &ps::PublicState::ComputeCfActionValues)
      .def("public_features_tensor",
           &ps::PublicState::PublicFeaturesTensor)
      .def("reach_probs_tensor",
           &ps::PublicState::ReachProbsTensor)
      .def("to_tensor",
           &ps::PublicState::ToTensor)
      .def("to_string",
           &ps::PublicState::ToString)
      .def("get_depth",
           &ps::PublicState::GetDepth)
      .def("is_root",
           &ps::PublicState::IsRoot)
      .def("clone",
           &ps::PublicState::Clone)
      .def("serialize",
           &ps::PublicState::Serialize)
      .def("get_base_game",
           &ps::PublicState::GetBaseGame)
      .def("get_public_game",
           &ps::PublicState::GetPublicGame);
