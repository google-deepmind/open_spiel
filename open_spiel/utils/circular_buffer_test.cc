...
const std::string kSimpleSerializationFilename = "simple_buffer_data.nop";
const std::string kComplexSerializationFilename = "complex_buffer_data.nop";
...
void TestSimpleCircularBufferSerialization() {
  CircularBuffer<int> original_buffer(6);
  ...
  CircularBuffer<int> new_buffer(6);
...
void TestComplexCircularBufferSerialization() {
  ...
  CircularBuffer<TestStruct> original_buffer(3);
  ...
  CircularBuffer<TestStruct> new_buffer(3);
...
int main(int argc, char** argv) {
  ...
  open_spiel::TestSimpleCircularBufferSerialization();
  open_spiel::TestComplexCircularBufferSerialization();
