...
export OPEN_SPIEL_PYTHON_JAX_DEPS="jax==0.3.7 dm-haiku==0.0.6 optax==0.1.2 chex==0.1.3 rlax==0.1.2"
export OPEN_SPIEL_PYTHON_PYTORCH_DEPS="torch==1.11.0"
export OPEN_SPIEL_PYTHON_TENSORFLOW_DEPS="numpy==1.21.5 tensorflow==2.8.0 tensorflow-probability<0.8.0,>=0.7.0 tensorflow_datasets==4.3.0 keras==2.8.0"
