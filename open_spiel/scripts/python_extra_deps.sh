...
if verlt $PY_VER 3.12; then
  ...
  export OPEN_SPIEL_PYTHON_MISC_DEPS="IPython==9.10.0 networkx==3.6.1 matplotlib==3.10.8 mock==5.2.0 nashpy==0.0.43 scipy==1.17.0 testresources==2.0.2 cvxopt==1.3.2 cvxpy==1.8.1 ecos==2.0.14 osqp==1.1.0 tensorflow_datasets==4.9.9 pokerkit==0.7.3"
fi
