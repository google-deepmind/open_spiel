...
export OPEN_SPIEL_PYTHON_JAX_DEPS="jax==0.4.10 jaxlib==0.4.10 dm-haiku==0.0.10 optax==0.1.7 chex==0.1.7 rlax==0.1.5 distrax==0.1.3"
export OPEN_SPIEL_PYTHON_PYTORCH_DEPS="torch==1.13.1"
export OPEN_SPIEL_PYTHON_TENSORFLOW_DEPS="numpy==1.24.3 tensorflow==2.13.1 tensorflow-probability==0.19.0 tensorflow_datasets==4.9.2 keras==2.13.1"
