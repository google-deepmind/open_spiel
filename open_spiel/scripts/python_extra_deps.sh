...
export OPEN_SPIEL_PYTHON_JAX_DEPS="jax==0.2.13 jaxlib==0.1.65 dm-haiku==0.0.3 optax==0.0.2 chex==0.0.7 rlax==0.0.3"
export OPEN_SPIEL_PYTHON_PYTORCH_DEPS="torch==1.8.1"
export OPEN_SPIEL_PYTHON_TENSORFLOW_DEPS="numpy==1.19.5 tensorflow==2.5.0 tensorflow-probability<0.8.0,>=0.7.0"
