// Copyright 2022 Thorsten Jungblut
//
...
const Coords kFieldToBoardString[] {
  // Common fields.
  { 0, 4 }, { 2, 4 }, { 4, 4 },  { 6, 4 }, { 8, 4 },
  { 8, 3 }, { 8, 2 }, { 8, 1 },  { 8, 0 }, { 10, 0 },
  { 12, 0 }, { 12, 1 }, { 12, 2 },  { 12, 3 }, { 12, 4 },
  { 14, 4 }, { 16, 4 }, { 18, 4 },  { 20, 4 }, { 20, 5 },
  { 20, 6 }, { 18, 6 }, { 16, 6 },  { 14, 6 }, { 12, 6 },
  { 12, 7 }, { 12, 8 }, { 12, 9 },  { 12, 10 }, { 10, 10 },
...
class MaednGame : public Game {
 public:
  ...
  std::unique_ptr<State> NewInitialState() const override {
    return std::unique_ptr<State>(new MaednState(
        shared_from_this(), two_player_opposite_));
  }
