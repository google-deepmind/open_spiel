...
#ifndef OPEN_SPIEL_GAMES_STONES_N_GEMS_H_
#define OPEN_SPIEL_GAMES_STONES_N_GEMS_H_
...
// A simplified version of common stone and gem games.
// Brief:
...
//     "blob_chance"            int    chance out of 256 each blob will spawn another (default = 20)
//     "blob_max_percentage"    double maximum blob growth size, as percentage of map (default = 0.16)
...
inline constexpr char kDefaultGrid[] =
    ...
    "19,02,02,02,02,02,02,02,02,03,02,02,02,02,02,03,02,02,02,19\n"
...
class StonesNGemsState : public State {
 public:
  ...
  StonesNGemsState(std::shared_ptr<const Game> game, int steps_remaining, int magic_wall_steps,
 ...
 public:
  ...
  std::unique_ptr<State> NewInitialState() const override {
    return std::unique_ptr<State>(
        new StonesNGemsState(shared_from_this(), max_steps_, magic_wall_steps_, false, blob_max_size_,
                         0, blob_chance_, kNullElement, true, gems_required_, 0, 0, 0, 
...
#endif  // OPEN_SPIEL_GAMES_STONES_N_GEMS_H_
