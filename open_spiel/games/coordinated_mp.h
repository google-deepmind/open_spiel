...
// that has multiple Nash equilibria lying on a line parametrized with one variable
// for the second player. He must coordinate his actions in the two infosets
// that he has, in such a way that p+q=1 for NE, where p and q are probabilities
// of playing Heads in top and bottom infosets respectively.
//
...
class PenniesState : public State {
 ...
 private:
    ...
    InfosetPosition infoset_ = kNoInfoset; // The infoset where we are in the game.
};
