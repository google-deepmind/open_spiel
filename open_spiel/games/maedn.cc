// Copyright 2022 Thorsten Jungblut <ulli@netcorner.org>
//
...
#include "open_spiel/games/maedn.h"
...
void MaednState::SetState(int cur_player, int dice,
                          int prev_player, int prev_dice,
