  ...
  namespace dou_dizhu {
    ...
    class DouDizhuGame: public Game{
      public:
        ...
        std::vector<int> ObservationTensorShape() const override {return {kObservationTensorSize};}
        int MaxGameLength() const override {return kMaxAuctionLength + kNumCards * kNumPlayers;}
    };
} // namespace dou_dizhu
} // namespace open_spiel
