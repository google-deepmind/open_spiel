...
void PartiallyObservableLaserTagDefaultObsTests() {
  ...
  SPIEL_CHECK_TRUE(AllNear(expected_obs_tensor_A, state->ObservationTensor(0),
                           tolerence));
  SPIEL_CHECK_TRUE(AllNear(expected_obs_tensor_B, state->ObservationTensor(1),
                           tolerence));
  ...
  expected_obs_string_A =
    ...
    "*********.......*****\n"
    "Orientations: 2 3\n";
  expected_obs_tensor_A = get_obs_tensor_from_string(expected_obs_string_A,
                                                     obs_grid_size);
  ...
  expected_obs_string_B =
    ...
    "*****.......*********\n"
    "Orientations: 2 3\n";
  expected_obs_tensor_B = get_obs_tensor_from_string(expected_obs_string_B,
                                                     obs_grid_size);
