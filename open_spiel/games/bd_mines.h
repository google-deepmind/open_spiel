...
//     - YamYams move either up, left, down, or right. If they hit another object, they randomly
//       start to move in another direction. Rockford will die if he runs into a YamYam.
...
class BDMinesState : public State {
 ...
 private:
  ...
  void UpdateYamYam(int index, int action);
