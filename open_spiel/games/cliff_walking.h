...
#ifndef THIRD_PARTY_OPEN_SPIEL_GAMES_CLIFF_WALKING_H_
#define THIRD_PARTY_OPEN_SPIEL_GAMES_CLIFF_WALKING_H_
...
#endif  // THIRD_PARTY_OPEN_SPIEL_GAMES_CLIFF_WALKING_H_
