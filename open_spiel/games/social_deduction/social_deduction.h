...
//
// Parameters:
//   "players"            int     number of players (default: 6)
//   "imposters"          int     number of imposters (default: 1)
//   "max_rounds"         int     maximum rounds to play (default: 10)
//   "observation_noise"  double  probability of noisy observation
//                                  (default: 0.1)
