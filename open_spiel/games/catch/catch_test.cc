...
void TestStateStruct() {
  ...
  std::string state_json = "{\"ball_col\":2,\"ball_row\":0,\"paddle_col\":2}";
...
void TestObservationStruct() {
  ...
  std::string obs_json = "{\"ball_col\":2,\"ball_row\":0,\"paddle_col\":2}";
...
void TestActionStruct() {
  ...
  SPIEL_CHECK_EQ(expected_actions,
                 catch_state->StructToActions(*action_struct));
}
