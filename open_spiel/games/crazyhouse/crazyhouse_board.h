...
#ifndef OPEN_SPIEL_GAMES_IMPL_CRAZYHOUSE_CRAZYHOUSE_BOARD_H_
#define OPEN_SPIEL_GAMES_IMPL_CRAZYHOUSE_CRAZYHOUSE_BOARD_H_
...
using crazyhouse_common::kInvalidSquare;  // NOLINT
using crazyhouse_common::Offset;
using crazyhouse_common::Square;
using crazyhouse_common::SquareToString;  // NOLINT

template <std::size_t... Dims>
using ZobristTableU64 = crazyhouse_common::ZobristTable<uint64_t, Dims...>;
...
struct Move {
  ...
  std::string ToLAN(bool chess960 = false,
                    const CrazyhouseBoard* board_ptr = nullptr) const;
  ...
  std::string ToSAN(const CrazyhouseBoard& board) const;
...
#endif  // OPEN_SPIEL_GAMES_IMPL_CRAZYHOUSE_CRAZYHOUSE_BOARD_H_
