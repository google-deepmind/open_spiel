...
void TestSimpleTransitiveCase() {
  ...
  std::vector<double> ratings2 = ComputeElo(win_matrix);
...
void TestMeeplePentathlon() {
  ...
  std::vector<double> ratings = ComputeElo(win_matrix);
